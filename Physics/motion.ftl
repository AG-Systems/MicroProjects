...
<@layout.template title="Motion" js="/js/motion.js" css="/css/motion.css">
    ...
    <div class="container">
        ...
        <div class="col-md-6 col-md-offset-3 col-xs-8 col-xs-offset-2">
            <div class="stage-selector input_fields_wrap">
                <a id="add2" href="#" class="btn btn-primary col-md-5">Add Stage</a>
                <a id="remove2" href="#" class="btn btn-warning col-md-5 col-md-offset-2">Remove Stage</a>
            </div>
        </div>
        <div class="col-md-5 col-md-offset-1">
            <div class="col-xs-12">
        ...
        <div class="col-md-4 col-md-offset-4 col-xs-6 col-xs-offset-3">
            <div class="form-group">
                <div class="col-md-6 col-xs-offset-3">
                    <input id="calculate2" class="btn btn-success btn-block" type="submit" value="Calculate!">
                </div>
            </div>
        </div>
